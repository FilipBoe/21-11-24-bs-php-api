                ...
                <div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                    <div class="block sm:ml-6">
                        <div class="flex space-x-4">
                            <a href="/" class="nav-link <?php echo url_is() ? 'nav-link--active' : ''; ?>">Posts</a>

                            <?php if (ticTacToeOpen()) { ?>
                                <a href="/tic-tac-toe" class="nav-link <?php echo url_is('/tic-tac-toe') ? 'nav-link--active' : ''; ?>">TicTacToe</a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    <a href="/settings" class="relative p-1 text-gray-400 bg-gray-800 rounded-full hover:text-white">
